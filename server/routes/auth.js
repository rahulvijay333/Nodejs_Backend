...
const {
  ...
  logoutDoctor,
  getDoctorDetails,
} = require("../controllers/authDoctor");
...
} = require("../controllers/authPatient");
...
router.put("/doctor/verify", doctorVerifyController);
...
router.put("/patient/verify", patientVerifyController);
